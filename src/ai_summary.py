...
🚨 НАЙ-ВАЖНО: Ако има новини за АЛОКАЦИЯ / НАЛИЧНОСТ на сярна киселина — това е по-важно от цената! TiO₂ е само 4.2% от световното потребление на H₂SO₄ (9.4% в Китай), а торовете са ~60%. При недостиг торовете се приоритизират и TiO₂ производителите просто НЕ ПОЛУЧАВАТ киселина. Производството спира независимо от това колко са готови да платят. Дай приоритет 5 на всяка новина за недостиг, рациониране или приоритизиране.

Ако има новини за ОПЕРАТИВНИ НИВА (operating rates) на китайските заводи — това е опреждащ индикатор, по-точен от ценовите новини. Историческа крива: 76% → 58% → 74% → 72% → 65% → 66%. Спад под 60% предвещава ценови скок 1-2 месеца напред. Коментирай текущото ниво спрямо тази крива.

Ако има новини за МАРЖОВЕ или СЕБЕСТОЙНОСТ — китайците губят -¥3,550/тон (-$521/тон). Това измерва КОЛКО ДЪЛГО могат да издържат. Когато загубата стане непоносима → вълна от спирания → ценови обрат. Коментирай дали загубата се разширява или свива.

Ако има новини за ЕКСПОРТНИ ОГРАНИЧЕНИЯ — това е РАЗЛИЧЕН механизъм от антидъмпинга! Китай забрани износа на сярна киселина и ограничи торовете за остатъка от 2026. Експортният контрол върху СУРОВИНА засяга производството навсякъде, докато вносните мита защитават конкретен пазар. Не ги смесвай.

Ако има новини за НЕПЛАНИРАНИ ПРЕКЪСВАНИЯ (force majeure, стачки, аварии, време) — те движат спот-цените ВЕДНАГА, за разлика от обявените затваряния. Примери: INEOS стачка Q2, Kronos Leverkusen downtime, Chemours ограничена наличност. Дай приоритет 4-5.

При новини за нови МИТА или РАЗСЛЕДВАНИЯ — коментирай накъде ще се пренасочат китайските обеми, използвайки размерите на пазарите: Европа 1000 кт · Северна Америка 1000 кт · ЮИ Азия 480 кт (вече наситен) · Южна Америка 180 кт · UK 90 кт · Африка 60 кт · Австралия 46 кт.
